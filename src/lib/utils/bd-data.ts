...
import type { Division as MemberDivision } from '@/types'
...
export const DIVISION_ID_BY_SLUG: Record<MemberDivision, string> = {
  barishal: '1',
  chattogram: '2',
  dhaka: '3',
  khulna: '4',
...
export const DIVISION_SLUG_BY_ID: Record<string, MemberDivision> = {
  '1': 'barishal',
  '2': 'chattogram',
  '3': 'dhaka',
  '4': 'khulna',
...
export function getBdDivisionBySlug(slug: MemberDivision) {
  return BD_DIVISIONS.find((d) => d.id === DIVISION_ID_BY_SLUG[slug])
}

/** Districts for a member-facing division slug. */
export function getDistrictsByDivisionSlug(slug: MemberDivision): District[] {
